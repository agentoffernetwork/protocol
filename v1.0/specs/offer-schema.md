...
| --- | --- | --- | --- |
| Public Offer | Agent and end user | `offer-schema-v1.0.json` | User-visible Offer, public goals and `goals[].pricing` |
...
validator. It requires the stable-v1.0 language-tag profile, unique Goal events,
