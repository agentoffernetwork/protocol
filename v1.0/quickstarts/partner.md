...
2. Register the Partner with `credentials.protocol_version: "1.0"`. AON then
...
reports. Select the current contract with `AON-Protocol-Version: 1.0`, send the
...
```json
{
  ...
  "contract_version": "1.0",
  "runtime_availability": "unvalidated",
  "access_eligibility": "not_publicly_specified",
  "version_selection": {
    "configured_1_0": { "action": "select", "contract_version": "1.0" },
    "omitted": { "action": "reject", "mode": "fail_closed" },
    "unknown": { "action": "reject", "mode": "fail_closed" }
  },
  "references": {
    "provider_api": {"repository": "agentoffernetwork/protocol", "path": "v1.0/specs/offer-provider-api.md"},
    "partner_offer_schema": {"repository": "agentoffernetwork/protocol", "path": "v1.0/specs/offer-partner-schema.md"},
    "public_offer_schema": {"repository": "agentoffernetwork/protocol", "path": "v1.0/specs/offer-schema.md"},
    "category_taxonomy": {"repository": "agentoffernetwork/protocol", "path": "v1.0/specs/category-taxonomy.md"},
    "location_targeting": {"repository": "agentoffernetwork/protocol", "path": "v1.0/specs/location-targeting.md"},
    "request_schema": {"repository": "agentoffernetwork/schema", "path": "v1.0/json-schema/offer-provider-request.json"},
    "response_schema": {"repository": "agentoffernetwork/schema", "path": "v1.0/json-schema/offer-provider-response.json"},
    "provider_request_example": {"repository": "agentoffernetwork/examples", "path": "v1.0/http/offer-provider/request.json"},
    "provider_success_example": {"repository": "agentoffernetwork/examples", "path": "v1.0/http/offer-provider/success.json"},
    "provider_postback_spec": {"repository": "agentoffernetwork/protocol", "path": "v1.0/specs/postback.md"},
    "provider_postback_schema": {"repository": "agentoffernetwork/schema", "path": "v1.0/json-schema/postback-partner-payload.json"},
    "provider_postback_success_json": {"repository": "agentoffernetwork/examples", "path": "v1.0/http/postback/partner/basic-conversion.json"},
    "provider_postback_success_http": {"repository": "agentoffernetwork/examples", "path": "v1.0/http/postback/partner/basic-conversion.http"},
    "provider_postback_error_json": {"repository": "agentoffernetwork/examples", "path": "v1.0/http/postback/partner/invalid-unknown-field.json"},
    "provider_postback_error_http": {"repository": "agentoffernetwork/examples", "path": "v1.0/http/postback/partner/invalid-unknown-field.http"}
  }
}
```
