...
location or age input for Query v0.3.
...
[AON Location Registry](https://github.com/agentoffernetwork/schema/blob/main/v0.3/locations/aon-location-registry.json).
...
[Offer JSON Schema](https://github.com/agentoffernetwork/schema/blob/main/v0.3/json-schema/offer-schema.json).

## Query boundary

The current Query v0.3 request exposes bounded platform and session context,
...
runtime policy remain outside this portable public request contract.

The old v0.1 Location Search API is a compatibility resource and is not part of
the current v0.3 Protocol tree.
