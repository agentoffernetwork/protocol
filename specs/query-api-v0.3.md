...
>
> v0.3 is the formal protocol adopted for new integrations and public
> documentation. Runtime deployment availability is owned by each API, MCP,
> Provider, and Host implementation; a deployment must provide conformance
> evidence before declaring the version available.
